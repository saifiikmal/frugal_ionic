...
const DashboardSelect: React.FC<DashboardSelectProps> = (props: DashboardSelectProps) => {
        ...
        <IonGrid>
          <IonRow>
            {props.dispensers.map((dispenser: any, i) =>  {
              ...
              return (
                <IonCol size='6' key={i}>
                  <IonCard color="light" routerLink={`/dashboard/${dispenser.dispenserId.macAddress}`}>
